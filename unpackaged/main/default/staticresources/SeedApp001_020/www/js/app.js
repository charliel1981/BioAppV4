...
.config(['$stateProvider', '$urlRouterProvider', '$ionicConfigProvider', function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  $stateProvider
    ...
    .state('tab.product-index', {
      ...
      views: {
        'products-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/productIndex.html',
    ...
    .state('tab.project-detail-webview', {
      url: '/project/:projectId/website',
      views: {
        'projects-tab': {
          templateUrl: RESOURCE_ROOT +  'templates/webView.html',
          controller: 'ProjectDetailCtrl'
        }
      }
    })
    ...
    .state('tab.project-expense-new-selectsurgeon', {
      url: '/project/:type/new/:projectId/surgeons',
      views: {
        'projects-tab': {
          templateUrl: RESOURCE_ROOT +  'templates/surgeonSelection.html',
          controller: 'SelectSurgeonCtrl'
        }
      }
    })

    .state('tab.project-expense-new-selectproduct', {
      url: '/project/:type/new/:projectId/products',
      views: {
        'projects-tab': {
          templateUrl: RESOURCE_ROOT +  'templates/productSelection.html',
