...
.run(['$ionicPlatform', 'NetworkService', 'AppRunStatusService', 'UserService', 'SyncService', 'logger', 'LocalNotificationService', 'appDataUtils', function($ionicPlatform, NetworkService, AppRunStatusService, UserService, SyncService, logger, LocalNotificationService, appDataUtils) {
